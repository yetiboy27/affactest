        ...
        $scope.$watch('areaInterest', function () {
	     ...
	     //    	$scope.stepTwoHeader = 'Undecided';
	    	...
	    	if ($scope.areaInterest == 'Business') {
		        ...
		        $scope.$watch('academicProgramOfInterest1', function () {
			        ...
			        // if ($scope.academicProgramOfInterest1 == '478fa38a-52b1-e011-b7aa-005056b8001d') {
			        	if (~programGuids.indexOf($scope.academicProgramOfInterest1)) {
