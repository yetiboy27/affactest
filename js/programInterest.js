...
var pgm8 = [
    ...
    {display: "Undergraduate Unknown", value: "74e72a1e-c8e8-e211-9330-005056b8001d" }
    ];
...
$("#field0, #field1").change(function () {
      
var field0 = $("#field0").val();
var field1 = $("#field1").val();

 if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "Undecided")) {
    list(pgm1);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "Undecided")) {
    list(pgm2);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "Business")) {
    list(pgm3);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "Business")) {
    list(pgm4);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "CIS")) {
    list(pgm5);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "CIS")) {
    list(pgm6);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "Education")) {
    list(pgm7);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "Education")) {
    list(pgm8);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "Healthcare")) {
    list(pgm9);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "Healthcare")) {
    list(pgm10);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "HSS")) {
    list(pgm11);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "HSS")) {
    list(pgm12);
    }
else if ((field0 == "0d5f51c4-8ed9-e011-8d3e-005056b8001d") && (field1 == "STEM")) {
    list(pgm13);
    }
else if ((field0 == "5ff36977-a473-e111-9cb6-005056b8001d") && (field1 == "STEM")) {
    list(pgm14);
    }
...
{
    $("#field2").val("").html(""); //reset child options
    $(array_list).each(function (i) { //populate child options
        $("#field2").append("<option value=\"" + array_list[i].value + "\">" + array_list[i].display + "</option>");
    });
    $("#field2").data("selectBox-selectBoxIt").refresh();
